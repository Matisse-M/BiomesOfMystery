...
static int rest_color(rpg_t *rpg, main_player_t *player,
    sfVector2f front_pixel, sfColor front_pixel_color)
{
    ...
    sfVector2f front_pixel)
{
    ...
    if (rest_color(rpg, player, front_pixel, front_pixel_color) == 0)
        return 0;
    return 1;
}
